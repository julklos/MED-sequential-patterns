...
if __name__ == "__main__":
    ...
    input_ = "../data/MT745584_SPMF.spmf"
    limit_ = [200, 100, 50,20]
    ...
    results_file = 'test_1.csv'
    algorithm_ = "PrefixSpan"
    #input_ = "../data/FIFA.spmf"
    ...
    for min_ in min_support_:
        for max_ in max_length_:
            for lim_ in limit_:
                output_ = "spmf_output_"+algorithm_+"_kosarak_"+str(i)+".json"
