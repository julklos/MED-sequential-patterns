...
def check_parameters(limit, min_support, max_length, min_length):
    if check_if_number(0, math.inf, limit) and check_if_number(0, 1, min_support) and check_if_number(1,math.inf, max_length) and check_if_number(1, math.inf, min_length):
        return True
    else: return False
